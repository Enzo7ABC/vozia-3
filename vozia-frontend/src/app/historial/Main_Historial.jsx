        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 text-slate-400">
            ...
            <p className="text-sm animate-pulse">
              Cargando llamadas guardadas en MongoDB Atlas...
            </p>
          </div>
        ) : error ? (
                      ...
                      <div className="border-t border-white/5 bg-slate-950/40 p-4 md:p-6 space-y-6">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                          ...
                          <div className="lg:col-span-6 space-y-3">
                            ...
                            <div className="rounded-xl border border-white/5 bg-slate-900/60 p-4 min-h-[160px] max-h-[240px] overflow-y-auto custom-scroll relative">
                              <div className="absolute left-0 top-0 bottom-0 w-1  from-cyan-500/20 to-purple-500/20 rounded-l-xl" />
